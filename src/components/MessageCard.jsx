...
function MessageCard({ isActive }) {
  ...
  const message = `Hi Potato,

I know I haven’t been talking much or been there this year, but I want to remind you that you are, and always will be, a very important person in my life.

You have no idea how freaking difficult it is to make this but wanted to do something different.
Congrats on the job, proud of you. Just make sure you are happy in whatever you do coz me likey your clown smile a little too much.

Hope this years brings alot of joy, less drama and no sad tears,
Meet more this year atleast woman (old friends are still gold, coz gold price is still alot cheaper compared to me )

Happy Birthday, act 26! 🎉

— Your old Panda AKA Hari`;
  ...
  return (
    <section className="message">
      <h2>💌 A Message from the bottom of my Heart if i have 1</h2>
