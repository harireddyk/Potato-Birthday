...
function CelebrationPage({ onComplete, musicPlayerRef }) {
  ...
  const slides = [
    {
      icon: "✨",
      text: "It's Your Iconic 26th Birthday Woohoo!",
      type: "announcement",
    },
    {
      icon: "✨",
    ...
    {
      icon: "✨",
      text: "Have a look at it Potatooo",
      type: "announcement",
    },
  ];
      ...
      {showButtons && (
        <>
          ...
          <div className="celebration-buttons">
            <h2 className="celebration-title">Time to Celebrate! 🎉</h2>
            ...
            <div className="buttons-grid">
              ...
              {showMessageButton && (
                ...
                >
                  💌 Well, I Have a Small Message for You Potato
                </button>
              )}
            </div>
          </div>
