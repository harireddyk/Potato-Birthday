    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Potato</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Potato's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Congrats for having mommy issues and other unamed issues at 26 💗</p>
        </section>
        ...
        <section className="teaser">
          ...
          <p className="teaser-hint">Some Iconic shit is about to unfold 💫</p>
        </section>
      ...
      >
        ...
        <button className="page-nav-btn" onClick={() => goToPage(4)}>
          📸 View Some Our Selected Memories
        </button>
      </div>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Your BFF - Panda 💖</h2>
          <p className="final-subtitle">Efforts matter man, HBD once again Potato ✨</p>
        </section>
      </div>
